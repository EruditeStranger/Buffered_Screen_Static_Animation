/**
 * Created by Rahul Basu on 7/14/2016.
 */
import java.awt.*;
...
public class BufferedScreen //To use Buffer Strategy and Page Flipping
{
    ...
    public DisplayMode findFirstCompatibleMode(DisplayMode mode[])
    {
        ...
        for(x = 0; x<mode.length; x++) //loop through the Display Modes
        {
            for(y=0;y<goodmode.length; y++) //loop through video card modes inside the Display Mode
            {
